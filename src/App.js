...
class App extends Component {
  ...
  componentDidMount() {
    fetch("https://todo-app-lucas.herokuapp.com/api/v1/todos/", {
      method: "GET"
    })
  ...
  handleSubmit = event => {
    ...
    fetch("https://todo-app-lucas.herokuapp.com/api/v1/todos/api/v1/todos", {
      method: "POST",
  ...
  removeButton = event => {
    ...
    fetch(`https://todo-app-lucas.herokuapp.com/api/v1/todos/${oldTodo._id}`, {
      method: "DELETE",
      headers: {}
    })
  ...
  completeButton = event => {
    ...
    fetch(`https://todo-app-lucas.herokuapp.com/api/v1/todos/${todo._id}`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({
